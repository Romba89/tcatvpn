...
mkdir -p /var/www/html/shadowsocks2023
...
# Paste Your domain recomanded cloudflare (record A)
touch /usr/local/etc/xray/domain
echo "Input Domain"
echo " "
read -rp "🐈domain recommended🐈 : " -e dns
if [ -z $dns ]; then
...
cipher="aes-128-gcm"
cipher2="2023-blake3-aes-128-gcm"
...
#shadowsocks2023-grpc
      ...
      "streamSettings":{
        "network": "grpc",
        "grpcSettings": {
          "serviceName": "shadowsocks2023-grpc",
          "alpn": [
            "h2",
            "http/1.1"
          ]
...
sed -i '$ ilocation /shadowsocks2023 {' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ ilocation ^~ /shadowsocks2023-grpc {' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
sed -i '$ igrpc_set_header X-Real-IP \$remote_addr;' /etc/nginx/conf.d/xray.conf
sed -i '$ igrpc_set_header X-Forwarded-For \$proxy_add_x_forwarded_for;' /etc/nginx/conf.d/xray.conf
sed -i '$ igrpc_set_header Host \$http_host;' /etc/nginx/conf.d/xray.conf
...
# Hosting
Romba89="raw.githubusercontent.com/Romba89/tcatvpn/main"
cd /usr/bin
## Menu
...
wget -O shadowsocks2023 "https://${Romba89}/xray/menu/shadowsocks2023.sh"
...
## Shadowsocks 2023
wget -O add-ss2023 "https://${Romba89}/xray/shadowsocks2023/add-ss2023.sh"
wget -O del-ss2023 "https://${Romba89}/xray/shadowsocks2023/del-ss2023.sh"
wget -O extend-ss2023 "https://${Romba89}/xray/shadowsocks2023/extend-ss2023.sh"
wget -O trialss2023 "https://${Romba89}/xray/shadowsocks2023/trialss2023.sh"
wget -O cek-ss2023 "https://${Romba89}/xray/shadowsocks2023/cek-ss2023.sh"
## Socks5
...
wget -O log-ss2023 "https://${Romba89}/xray/log/log-ss2023.sh"
...
chmod +x trialss
chmod +x cek-ss
## Chmod Shadowsocks 2023
chmod +x add-ss2023
chmod +x del-ss2023
chmod +x extend-ss2023
chmod +x trialss2023
chmod +x cek-ss2023
## Chmod Socks5
chmod +x add-socks
...
echo ""
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
echo -e "                  ${WB}Multi v2 dns Script BY MAHBOUB-MILLION${NC}"
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
...
echo -e "  ${YB}- Shadowsocks 2023${NC}        ${WB}|${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
